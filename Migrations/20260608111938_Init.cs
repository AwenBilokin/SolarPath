        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeasonStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SeasonEnd = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    GeoData = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routes_AspNetUsers_GuideId",
                        column: x => x.GuideId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "bi-person-walking", "Пішохідні" },
                    { 2, "bi-bicycle", "Велосипедні" },
                    { 3, "bi-building-fill", "Культурні" },
                    { 4, "bi-water", "Водні" },
                    { 5, "bi-mountain", "Гірські" }
                });
