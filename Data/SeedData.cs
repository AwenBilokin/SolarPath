...
public static class SeedData
{
    ...
    private static async Task FixBrokenImageUrlsAsync(IServiceProvider services)
    {
        ...
        var fixes = new[]
        {
            ("photo-1599394020900-19c4843a8a93", "https://images.unsplash.com/photo-1520209759809-a9bcb6cb3241?w=1200&q=85&fit=crop&auto=format"), // Львів
            ("photo-1601122700611-369bc1a96b71", "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=85&fit=crop&auto=format"), // Буковина
            ("photo-1467269204594-9661b134dd2b", "https://images.unsplash.com/photo-1520209759809-a9bcb6cb3241?w=1200&q=85&fit=crop&auto=format"), // Львів (попередня заміна)
            ("photo-1518495973542-4542c06a5843", "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1200&q=85&fit=crop&auto=format"), // Синевир
            ("photo-1559521783-1d1599583485",    "https://images.unsplash.com/photo-1520209759809-a9bcb6cb3241?w=1200&q=85&fit=crop&auto=format"), // Хотинська фортеця
            ("photo-1486870591958-9b9d0d1dda99", "https://images.unsplash.com/photo-1541625602330-2277a4c46182?w=1200&q=85&fit=crop&auto=format"), // Південний Буг
            ("photo-1530866495561-507c9faab2ed", "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=1200&q=85&fit=crop&auto=format"), // Стрий
            ("photo-1441974231531-c6227db76b6e", "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200&q=85&fit=crop&auto=format"), // Тунель кохання
            ("photo-1454496522488-7a8e488e8606", "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=85&fit=crop&auto=format"), // Бескиди
            ("photo-1544551763-46a013bb70d5",    "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=1200&q=85&fit=crop&auto=format"), // Десна
        };
