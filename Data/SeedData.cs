...
public static class SeedData
{
    ...
    /// </summary>
    /// <summary>
    /// Замінює нестабільні посилання (source.unsplash.com, локальні SVG-залишки
    /// попередніх фіксів) на стабільні Picsum-зображення з фіксованим seed.
    /// SVG використовується лише як fallback за категорією, коли фото не задано.
    ...
    private static async Task FixBrokenImageUrlsAsync(IServiceProvider services)
    {
        ...
        // Назва маршруту -> стабільний Picsum URL
        var restoreMap = new Dictionary<string, string>
        {
            ["Говерла — Корона Карпат"]                          = "https://picsum.photos/seed/hoverla-carpathians/1200/800",
            ["Софіївський парк — Садова казка Умані"]            = "https://picsum.photos/seed/sofiyivka-park/1200/800",
            ["Каньйон Дністер — Річковий лабіринт"]              = "https://picsum.photos/seed/dniester-canyon/1200/800",
            ["Велотур Закарпаттям — Виноградні долини"]          = "https://picsum.photos/seed/zakarpattia-bike/1200/800",
            ["Шлях Довбуша — Скелі легенд"]                       = "https://picsum.photos/seed/dovbush-rocks/1200/800",
            ["Кам'янець-Подільський — Місто над прірвою"]        = "https://picsum.photos/seed/kamianets-fortress/1200/800",
            ["Синевир — Перлина Карпат"]                          = "https://picsum.photos/seed/synevyr-lake/1200/800",
            ["Хотинська фортеця — Сторожа Дністра"]              = "https://picsum.photos/seed/khotyn-fortress/1200/800",
            ["Велотур Південним Бугом — Гранітні каньйони"]      = "https://picsum.photos/seed/southern-bug/1200/800",
            ["Сплав по Стрию — Карпатська течія"]                = "https://picsum.photos/seed/stryi-rafting/1200/800",
            ["Тунель кохання — Клевань"]                          = "https://picsum.photos/seed/tunnel-of-love/1200/800",
            ["Львів — Підземними легендами старого міста"]       = "https://picsum.photos/seed/lviv-oldtown/1200/800",
            ["Бескиди — Хребтова стежка Парашки"]                = "https://picsum.photos/seed/beskydy-parashka/1200/800",
            ["Велотур Буковиною — Дерев'яні церкви та полонини"] = "https://picsum.photos/seed/bukovyna-bike/1200/800",
            ["Каякінг по Десні — Тиха річкова подорож"]          = "https://picsum.photos/seed/desna-kayak/1200/800",
        };
